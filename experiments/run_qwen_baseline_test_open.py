...
IMG_DIR = Path("datasets/test_open/images")

OUT_JSONL = Path("runs/qwen2_5_vl/baseline/test_open/raw/p1_baseline_test_open.jsonl")
OUT_LOGDIR = Path("runs/qwen2_5_vl/baseline/test_open/logs")
OUT_EVALDIR = Path("runs/qwen2_5_vl/baseline/test_open/eval")
