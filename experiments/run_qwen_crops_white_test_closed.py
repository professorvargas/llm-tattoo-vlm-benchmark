...
IN_JSONL = Path("runs/gemma3/crops_white/test_closed/raw/p1_crop_white_test_closed.jsonl")

OUT_JSONL = Path("runs/qwen2_5_vl/crops_white/test_closed/raw/p1_crop_white_test_closed.jsonl")
OUT_LOGDIR = Path("runs/qwen2_5_vl/crops_white/test_closed/logs")
OUT_EVALDIR = Path("runs/qwen2_5_vl/crops_white/test_closed/eval")
