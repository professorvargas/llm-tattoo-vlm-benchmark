...
def main():
    ...
    (base/"_summary_labels_qwen.json").write_text(json.dumps(all_sum, ensure_ascii=False, indent=2), encoding="utf-8")
    print("Saved:", base/"_summary_labels_qwen.json")
