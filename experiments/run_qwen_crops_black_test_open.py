...
IN_JSONL = Path("runs/gemma3/crops_black/test_open/raw/p1_crop_test_open.jsonl")

OUT_JSONL = Path("runs/qwen2_5_vl/crops_black/test_open/raw/p1_crop_test_open.jsonl")
OUT_LOGDIR = Path("runs/qwen2_5_vl/crops_black/test_open/logs")
OUT_EVALDIR = Path("runs/qwen2_5_vl/crops_black/test_open/eval")
